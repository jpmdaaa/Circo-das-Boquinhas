...
namespace Playmove.Framework.Keyboards
{
    ...
    public class Display : MonoBehaviour
    {
        ...
        [SerializeField] private List<TextMeshProUGUI> _characters = new();
        ...
        public void SetText(string text)
        {
            ...
            if (text.Length > DISPLAY_LENGTH)
                Debug.LogWarning(
                    "Keyboard display dont support texts that exceeds 20 chars the text will be truncated!");
        ...
        private void OnCursorChangedPosition(int cursorPosition)
        {
            ...
            {
                var rect = _characters[_characters.Count - 1].GetComponent<RectTransform>();
