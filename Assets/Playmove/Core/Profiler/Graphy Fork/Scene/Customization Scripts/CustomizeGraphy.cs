...
namespace Tayx.Graphy.CustomizationScene
{
    public class CustomizeGraphy : MonoBehaviour
    {
        ...
        [Header("Customize Graphy")] [SerializeField]
        ...
        [Header("Fps")] [SerializeField] private Dropdown m_fpsModuleStateDropdown;
        ...
        [Header("Memory")] [SerializeField] private Dropdown m_ramModuleStateDropdown;
        ...
        [Header("Audio")] [SerializeField] private Dropdown m_audioModuleStateDropdown;
        ...
        [Header("Advanced")] [SerializeField] private Dropdown m_advancedModulePositionDropdown;
        ...
        [Header("Other")] [SerializeField] private Button m_musicButton;
        ...
        [SerializeField] private List<AudioClip> m_sfxAudioClips = new();
        ...
        private void SetupCallbacks()
        {
            ...
            {
                int threshold;
                if (int.TryParse(value, out threshold)) m_graphyManager.GoodFPSThreshold = threshold;
            });

            m_cautionInputField.onValueChanged.AddListener(value =>
            {
                int threshold;
                if (int.TryParse(value, out threshold)) m_graphyManager.CautionFPSThreshold = threshold;
            });
            ...
            m_advancedModuleToggle.onValueChanged.AddListener(
                value => m_graphyManager.AdvancedModuleState =
                    value ? GraphyManager.ModuleState.FULL : GraphyManager.ModuleState.OFF);
