    ...
    public static class DownloadLocalization
    {
        ...
        private static void DownloadRegisteredLanguages(Action<List<string>> completed)
        {
            ...
            var url = string.Format(
                @"https://api.playmove.com.br/api/v2/LocalizacaoApps/ListarLocalizacaoApp?executavel={0}.exe",
        ...
        private static void DownloadLocalizationFilesForLanguages(List<string> languages,
            Action<List<string>> completed,
        ...
        {
            var url = string.Format(
                "https://api.playmove.com.br/api/v2/LocalizacaoApps/ListarTodos?Filtro.Executavel={0}.exe&Filtro.Localizacao={1}",
