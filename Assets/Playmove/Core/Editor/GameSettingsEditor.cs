...
namespace Playmove.Core.Editor
{
    ...
    {
        private readonly List<string> _updateLocalizationLogs = new();
        private Vector2 _scrollPosition = Vector2.zero;

        private GameSettings _target;
        ...
        {
            GameSettings.PlayFromPlaytableBootstrap =
                serializedObject.FindProperty("_playFromPlaytableBootstrap").boolValue;
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.LabelField("This settings is used when building the game for Playtable, " +
                                       "when build finishes this settings is restored",
        ...
        private void DrawLogsForUpdateLocalization()
        {
            ...
            GUILayout.BeginVertical(GUI.skin.box, GUILayout.Width(Screen.width * 0.75f), GUILayout.MinHeight(120),
