...
namespace Playmove.Core.Editor.Bundles
{
    ...
    {
        private List<PlayAsset> _assetsWithoutTag = new();

        private AssetsCatalog _catalog;
        private List<PlayAsset> _deletedAssets = new();
        private Dictionary<string, List<PlayAsset>> _duplicatedAssets = new();
        private bool _showDevKitAssets;
        ...
        {
            var catalog = DevKit.AssetsCatalog;
        ...
        public override void OnInspectorGUI()
        {
            ...
            PlaytablePrefs.Set($"{DevKit.ProjectName}/AssetCatalogIgnoreWarnings", EditorGUILayout.Toggle(
                "Ignore warnings",
            ...
            if (DrawFoldout("IgnoredFolders", "Ignored Folders: " + _catalog.IgnoredFolders.Count))
            {
                ...
                GUILayout.Label(
                    "You can use just relative path like: /Global/Content/ this will ignore all content assets",
            ...
            if (DrawFoldout("Duplicated assets tags",
                    "Duplicated assets tags: " + _duplicatedAssets.Sum(data => data.Value.Count)))
            {
                GUILayout.BeginVertical(GUI.skin.box, GUILayout.Width(Screen.width - 40));
            ...
            if (DrawFoldout("Deleted assets", "Deleted assets: " + deletedAssets.Count))
            {
                ...
                foreach (var asset in deletedAssets.GetRange(0, deletedAssets.Count))
                {
                    ...
                    GUILayout.EndHorizontal();
                    var path = asset.RelativePath.Replace(Application.dataPath, "Assets");
                    if (path.Length > 70)
        ...
        {
            var asset = BuildAssetsCatalog.CreatePlayAsset(ignoredAsset.Tag, ignoredAsset.AssetName,
