...
namespace Playmove.Core.Controls
{
    public class ControlSlider : Openable
    {
        ...
        public PlaytableEventFloat OnValueChanged = new();

        [SerializeField] private Slider _slider;
        [SerializeField] private Button _buttonMin;
        [SerializeField] private Button _buttonMax;
        ...
        {
            var events = _slider.onValueChanged;
