...
namespace Playmove.Core.Audios
{
    ...
    {
        private readonly PlaytableEvent<AudioData> _onPause = new();
        private readonly PlaytableEvent<AudioData> _onResume = new();
        private readonly PlaytableEvent<AudioData> _onSequenceCompleted = new();
        private readonly PlaytableEvent<AudioData> _onStart = new();
        private readonly PlaytableEvent<AudioData> _onStop = new();
        private readonly Dictionary<float, PlaytableEvent<AudioData>> _timeTriggers = new();
        ...
        private float _lowestTimeTrigger;
        ...
        public AudioClip CurrentClip =>
            _currentClipIndex < _clips.Length ? _clips[_currentClipIndex] : null;
