...
namespace Playmove.Core.Bundles
{
    ...
    public static class Content
    {
        ...
        /// </summary>
        public static List<Bundle> SelectedContents { get; private set; }
        ...
        /// <param name="defaultValue">DefaultValue in case none asset is found if not specified null will be default</param>
        /// <returns>List of assets requested or defaultValue</returns>
        public static List<ContentAsset<T>> GetContentAssetsFromAllContents<T>(PlayAsset asset,
            List<ContentAsset<T>> defaultValue = default)
        {
        ...
        /// <param name="defaultValue">DefaultValue in case none asset is found if not specified null will be default</param>
        /// <returns>List of assets requested or defaultValue</returns>
        public static List<ContentAsset<T>> GetContentAssetsFromAllContents<T>(string assetName,
            List<ContentAsset<T>> defaultValue = default)
        {
            var assets = new List<ContentAsset<T>>();
            foreach (var bundle in PlaytableBundle.Instance.GetContentBundles())
        ...
        public static List<ContentAsset<T>> GetContentAssetsFromAllContents<T>(
            List<ContentAsset<T>> defaultValue = default)
        {
            var assets = new List<ContentAsset<T>>();
            foreach (var bundle in PlaytableBundle.Instance.GetContentBundles())
