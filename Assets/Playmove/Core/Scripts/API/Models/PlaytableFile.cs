...
namespace Playmove.Core.API.Models
{
    ...
    public class PlaytableFileProperties
    {
        ...
        public List<long> PlayersId = new();
        public string Name;
        public string Data;
    ...
    {
        [JsonIgnore] protected Sprite _spriteCache;
        ...
        public List<long> PlayersId { get; set; } = new();
        ...
        public string Language
        {
            get => RawFile.Language;
            set => RawFile.Language = value;
        }

        public string Extension
        {
            get => RawFile.Extension;
