...
namespace Playmove.Core.API.Services
{
    ...
    public class PlaytableFileService : Service<PlaytableFile, ArquivoAplicativoVm>
    {
            ...
            }, result =>
            {
                ...
                if (!parsedResult.HasError)
                    parsedResult.Data = parsedResult.Data
                        .Where(file => !file.Deleted && file.Language.ToLower() == language.ToLower()).ToList();
        ...
        public void GetPlayerFiles(long playerId, AsyncCallback<List<PlaytableFile>> completed)
        {
            ...
            WebRequestWrapper.Instance.Get("/ArquivoAplicativos/GetAllByFilter", parameters,
                result =>
                {
                    ...
                    {
                        var filesGroupedVm =
                            JsonConvert.DeserializeObject<Dictionary<string, List<ArquivoAplicativoVm>>>(result.Data
                                .text);
        ...
        {
            WebRequestWrapper.Instance.Get("/ArquivoAplicativos/GetAllInTrash",
        ...
        {
            WebRequestWrapper.Instance.Get("/ArquivoAplicativos/Get",
