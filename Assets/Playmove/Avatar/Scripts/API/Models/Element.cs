...
namespace Playmove.Avatars.API.Models
{
    ...
    public class Element : VmItem<ElementoVm>, IDatabaseItem
    {
        ...
        [NonSerialized] private Sprite _fullSpriteCache;
        ...
        public string ThumbnailPath => $"{AvatarAPI.RootAvatarPath}/Files/Avatar/{ThumbnailGUID}.png";

        public string FullPath
        {
            get
            {
                var fullPath = $"{AvatarAPI.RootAvatarPath}/Files/Avatar/{AppliedGUID}.png";
