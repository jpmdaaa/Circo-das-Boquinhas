...
namespace Playmove.Metrics.API
{
    ...
    public static class MetricsAPI
    {
        ...
        private static readonly List<StageEvent> _currentStageEvents = new();
        ...
        {
//              Debug.LogError(GlobalDebugs.Instance.DebugMetrics);
            if (GlobalDebugs.Instance.DebugMetrics) Debug.Log("Debug Metrics : StartSession");
            
            Metrics.StartSession(
                result => { _currentSession = result.Data; });
        }
        ...
        {
            if (GlobalDebugs.Instance.DebugMetrics) Debug.Log("Debug Metrics : EndSession");
        ...
        {
            if (GlobalDebugs.Instance.DebugMetrics) Debug.Log("Debug Metrics : StartMatch - GameMode = " + gameMode + " -  Difficulty = " + difficulty + " - TotalStages = " + totalStages);
        ...
        {
            if (GlobalDebugs.Instance.DebugMetrics) Debug.Log("Debug Metrics : StartEvent - Player = " + players[0] + " - Question = " + question);
        ...
        {
            if (GlobalDebugs.Instance.DebugMetrics) Debug.Log("Debug Metrics : EndEvent - Player = " + players[0] + " - RightAnswer = " + rightAnswer + " - PlayerAnswer = " + playerAnswer);
        ...
        {
            if (GlobalDebugs.Instance.DebugMetrics) Debug.Log("Debug Metrics : CancelEvent - Player = " + players[0]);
        ...
        {
            if (GlobalDebugs.Instance.DebugMetrics) Debug.Log("Debug Metrics : EndMatch - Reason = " + reason + " - Player = " + players[0] + " - Completed = " + completed);
            ...
            if (_currentMatch != null)
            {
                ...
                Metrics.SaveMatch(_currentMatch, result => { completed?.Invoke(result); });
            }
        }
