...
namespace Playmove.Metrics.API.Services
{
    ...
    public class ScoreService
    {
        ...
        {
            WebRequestWrapper.Instance.Get("/Metricas/GetRanking",
                new Dictionary<string, string> { { "gameGUID", GameSettings.GUID } }, result =>
                {
                    var parsedResult = Service<Ranking, RankingVm>.ParseVmJson(result);
