...
namespace TouchScript.Editor.Gestures
{
    ...
    {
        private static readonly GUIContent TIME_TO_PRESS =
            new("Time to Press (sec)", "Limit maximum number of simultaneous touch points.");

        private static readonly GUIContent DISTANCE_LIMIT =
            new("Limit Movement (cm)", "Gesture fails if fingers move more than <Value> cm.");
