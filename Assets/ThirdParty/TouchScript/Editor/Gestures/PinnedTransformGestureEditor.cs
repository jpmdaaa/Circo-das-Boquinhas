...
namespace TouchScript.Editor.Gestures
{
    ...
    {
        private static readonly GUIContent PROJECTION = new("Projection Type",
            "Method used to project 2d screen positions of touch points into 3d space.");

        private static readonly GUIContent PROJECTION_NORMAL = new("Projection Normal",
            "Normal of the plane in 3d space where touch points' positions are projected.");
