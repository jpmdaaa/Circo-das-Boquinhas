...
namespace TouchScript.Editor.Gestures
{
    ...
    {
        private static readonly GUIContent DIRECTION = new("Direction", "Flick direction.");

        private static readonly GUIContent MOVEMENT_THRESHOLD = new("Movement Threshold (cm)",
            "Minimum distance in cm touch points must move for the gesture to begin.");

        private static readonly GUIContent FLICK_TIME = new("Flick Time (sec)",
            "Time interval in seconds during which touch points must move by <Minimum Distance> for the gesture to be recognized.");

        private static readonly GUIContent MIN_DISTANCE = new("Minimum Distance (cm)",
            "Minimum distance in cm touch points must move in <Flick Time> seconds for the gesture to be recognized.");
