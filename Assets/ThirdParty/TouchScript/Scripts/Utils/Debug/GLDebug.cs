...
namespace TouchScript.Utils.Debug 
{
    public class GLDebug : MonoBehaviour
    {
        ...
        public static int DrawLine(Vector3 start, Vector3 end, Color? color = null, float duration = 0, bool depthTest =
 false)
        {
            return DrawLine(null, start, end, color, duration, depthTest);
        }

        public static int DrawLine(int? id, Vector3 start, Vector3 end, Color? color = null, float duration =
 0, bool depthTest = false)
        {
        ...
        public static int DrawLineScreenSpace(int? id, Vector2 start, Vector2 end, Color? color = null, float duration =
 0)
        {
        ...
        public static int DrawRay(Vector3 start, Vector3 dir, Color? color = null, float duration = 0, bool depthTest =
 false)
        {
            return DrawRay(null, start, dir, color, duration, depthTest);
        }

        public static int DrawRay(int? id, Vector3 start, Vector3 dir, Color? color = null, float duration =
 0, bool depthTest = false)
        {
            if (dir == Vector3.zero)
                return 0;
        ...
        public static int DrawCross(Vector3 pos, Quaternion? rot = null, Vector3? scale = null, Color? color =
 null, float duration = 0, bool depthTest = false)
        {
            return DrawCross(null, Matrix4x4.TRS(pos, rot ?? Quaternion.identity, scale ?? Vector3.one), color, duration, depthTest);
        }

        public static int DrawCross(int? id, Vector3 pos, Quaternion? rot = null, Vector3? scale = null, Color? color =
 null, float duration = 0, bool depthTest = false)
        {
        ...
        public static int DrawCross(int? id, Matrix4x4 matrix, Color? color = null, float duration = 0, bool depthTest =
 false)
        {
            return drawFigure(id, createCrossLines(matrix), color ?? Color.white, duration, depthTest);
        }

        public static int DrawCrossScreenSpace(Vector2 pos, float rot = 0, Vector2? scale = null, Color? color =
 null, float duration = 0)
        {
            return DrawCrossScreenSpace(null, pos, rot, scale, color, duration);
        }

        public static int DrawCrossScreenSpace(int? id, Vector2 pos, float rot = 0, Vector2? scale = null, Color? color
 = null, float duration = 0)
        {
        ...
        public static int DrawArrow(Vector3 start, Vector3 end, float arrowHeadLength = 0.25f, float arrowHeadAngle =
 20, Color? color = null, float duration = 0, bool depthTest = false)
        {
            return DrawArrow(null, start, end, arrowHeadLength, arrowHeadAngle, color, duration, depthTest);
        }

        public static int DrawArrow(int? id, Vector3 start, Vector3 end, float arrowHeadLength =
 0.25f, float arrowHeadAngle = 20, Color? color = null, float duration = 0, bool depthTest = false)
        {
            if (start == end)
                return 0;
        ...
        public static int DrawPlaneWithNormal(Vector3 pos, Vector3 normal, float scale = 1f, Color? color =
 null, float duration = 0, bool depthTest = false)
        {
            return DrawPlaneWithNormal(null, pos, normal, scale, color, duration, depthTest);
        }

        public static int DrawPlaneWithNormal(int? id, Vector3 pos, Vector3 normal, float scale = 1f, Color? color =
 null, float duration = 0, bool depthTest = false)
        {
        ...
        public static int DrawLineWithCross(Vector3 start, Vector3 end, float crossRelativePosition =
 0.5f, Vector3? scale = null, Color? color = null, float duration = 0, bool depthTest = false)
        {
            return DrawLineWithCross(null, start, end, crossRelativePosition, scale, color, duration, depthTest);
        }

        public static int DrawLineWithCross(int? id, Vector3 start, Vector3 end, float crossRelativePosition =
 0.5f, Vector3? scale = null, Color? color = null, float duration = 0, bool depthTest = false)
        {
        ...
        public static int DrawLineWithCrossScreenSpace(Vector2 start, Vector2 end, float crossRelativePosition, Vector2? scale
 = null, Color? color = null, float duration = 0)
        {
            return DrawLineWithCrossScreenSpace(null, start, end, crossRelativePosition, scale, color, duration);
        }

        public static int DrawLineWithCrossScreenSpace(int? id, Vector2 start, Vector2 end, float crossRelativePosition, Vector2? scale
 = null, Color? color = null, float duration = 0)
        {
            var lines = new List<Line>() {new Line(start, end)};
        ...
        public static int DrawSquare(Vector3 pos, Quaternion? rot = null, Vector3? scale = null, Color? color =
 null, float duration = 0, bool depthTest = false)
        {
            return DrawSquare(null, pos, rot, scale, color, duration, depthTest);
        }

        public static int DrawSquare(int? id, Vector3 pos, Quaternion? rot = null, Vector3? scale = null, Color? color =
 null, float duration = 0, bool depthTest = false)
        {
        ...
        public static int DrawSquare(int? id, Matrix4x4 matrix, Color? color = null, float duration = 0, bool depthTest
 = false)
        {
            return drawFigure(id, createSquareLines(matrix), color ?? Color.white, duration, depthTest);
        }

        public static int DrawSquareScreenSpace(Vector2 pos, float rot = 0, Vector2? scale = null, Color? color =
 null, float duration = 0)
        {
            return DrawSquareScreenSpace(null, pos, rot, scale, color, duration);
        }

        public static int DrawSquareScreenSpace(int? id, Vector2 pos, float rot = 0, Vector2? scale = null, Color? color
 = null, float duration = 0)
        {
        ...
        public static int DrawCube(Vector3 pos, Quaternion? rot = null, Vector3? scale = null, Color? color =
 null, float duration = 0, bool depthTest = false)
        {
            return DrawCube(null, pos, rot, scale, color, duration, depthTest);
        }

        public static int DrawCube(int? id, Vector3 pos, Quaternion? rot = null, Vector3? scale = null, Color? color =
 null, float duration = 0, bool depthTest = false)
        {
        ...
        public static int DrawCube(int? id, Matrix4x4 matrix, Color? color = null, float duration = 0, bool depthTest =
 false)
        {
        ...
        private static int drawFigure(int? id, List<Line> lines, Color color, float duration = 0, bool depthTest =
 false)
        {
        ...
        private static List<Line> createArrowLines(Vector3 start, Vector3 end, float arrowHeadLength =
 0.25f, float arrowHeadAngle = 20)
        {
            var dir = end - start;
            Vector3 right =
 Quaternion.LookRotation(dir) * Quaternion.Euler(0, 180 + arrowHeadAngle, 0) * Vector3.forward;
            Vector3 left =
 Quaternion.LookRotation(dir) * Quaternion.Euler(0, 180 - arrowHeadAngle, 0) * Vector3.forward;
