...
namespace TouchScript.Utils
{
    ...
    {
        private static readonly StringBuilder hashString = new();
        ...
        /// <returns>
        ///     Centroid of touch points' positions or <see cref="TouchManager.INVALID_POSITION" /> if cluster contains no
        ///     points.
        /// </returns>
        ...
        /// <param name="touches">List of touch points.</param>
        /// <returns>
        ///     Centroid of previous touch point's positions or <see cref="TouchManager.INVALID_POSITION" /> if cluster
        ///     contains no points.
        /// </returns>
