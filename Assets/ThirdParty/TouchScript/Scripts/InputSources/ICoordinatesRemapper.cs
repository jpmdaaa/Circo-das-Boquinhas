...
namespace TouchScript.InputSources
{
    ...
    /// </summary>
    /// <remarks>
    ///     If your input device is not fully aligned with display device you can use a remapper to carefully retarget touch
    ///     positions to "calibrate" input with image.
    /// </remarks>
