...
namespace TouchScript.InputSources
{
    ...
    /// </summary>
    [Obsolete("MouseInput is deprecated! Please use StandardInput instead.")]
    public sealed class MouseInput : InputSource
    {
        ...
        /// </summary>
        /// <remarks>
        ///     Operation Systems which support touch input send first touches as mouse clicks which may result in duplicated touch
        ///     points in exactly the same coordinates. This affects clusters and multitouch gestures.
        /// </remarks>
        ...
        /// </summary>
        public Tags Tags = new(Tags.INPUT_MOUSE);
