...
namespace TouchScript.InputSources
{
    ...
    public sealed class StandardInput : InputSource
    {
        ...
        /// </summary>
        public Tags TouchTags = new(Tags.INPUT_TOUCH);

        /// <summary>
        ///     Tags added to mouse touches coming from this input.
        /// </summary>
        public Tags MouseTags = new(Tags.INPUT_MOUSE);

        /// <summary>
        ///     Tags added to pen touches coming from this input.
        /// </summary>
        public Tags PenTags = new(Tags.INPUT_PEN);
        ...
        {
            windows8TouchHandler =
 new Windows8TouchHandler(TouchTags, MouseTags, PenTags, beginTouch, moveTouch, endTouch, cancelTouch);
