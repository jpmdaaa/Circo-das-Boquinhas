...
{
    /// <summary>
    ///     Mobile Input Source. Gathers touch input from built-in Unity's Input.Touches API. Though, should be used on mobile
    ///     devices.
    /// </summary>
    [Obsolete("MobileInput is deprecated! Please use StandardInput instead.")]
    public sealed class MobileInput : InputSource
    {
        ...
        /// </summary>
        [ToggleLeft] public bool DisableOnNonTouchPlatforms = true;

        /// <summary>
        ///     Tags added to touches coming from this input.
        /// </summary>
        public Tags Tags = new(Tags.INPUT_TOUCH);
