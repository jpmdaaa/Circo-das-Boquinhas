...
namespace TouchScript.Gestures.Clustered
{
    ...
    [HelpURL(
        "http://touchscript.github.io/docs/html/T_TouchScript_Gestures_Clustered_ClusteredScreenTransformGesture.htm")]
    public class ClusteredScreenTransformGesture : ScreenTransformGesture
    {
        #region Private variables

        private readonly Clusters.Clusters clusters = new();
