...
namespace TouchScript.Gestures
{
    ...
    public abstract class Gesture : DebuggableMonoBehaviour
    {
        ...
        private void requiredToFailGestureStateChangedHandler(object sender, GestureStateChangeEventArgs e)
        {
            ...
            switch (e.State)
            {
                case GestureState.Failed:
                    ...
                    if (delayedStateChange != GestureState.Possible) setState(delayedStateChange);
                    break;
        ...
        /// <remarks>
        ///     At the end of a gesture when touches are lifted off due to the fact that computers are faster than humans the very
        ///     last touch's position will be gesture's <see cref="ScreenPosition" /> after that. This flag is used to combine
        ///     several touch which from the point of a user were lifted off simultaneously and set their centroid as gesture's
        ///     <see cref="ScreenPosition" />.
        /// </remarks>
        ...
        /// <summary>
        ///     Gets or sets time interval before gesture is recognized to combine all lifted touch points into a cluster to use
        ///     its center as <see cref="ScreenPosition" />.
        /// </summary>
        ...
        /// <summary>
        ///     Gets or sets a value indicating whether state change events are broadcasted if <see cref="UseSendMessage" /> is
        ///     true..
        /// </summary>
        /// <value> <c>true</c> if state change events should be broadcaster; otherwise, <c>false</c>. </value>
        public bool SendStateChangeMessages
        {
            get => sendStateChangeMessages;
        ...
        /// </summary>
        protected List<TouchPoint> activeTouches = new(10);
        ...
        [SerializeField] private int minTouches;

        [SerializeField] private int maxTouches;

        [SerializeField] [ToggleLeft] private bool combineTouches;

        [SerializeField] private float combineTouchesInterval = .3f;

        [SerializeField] [ToggleLeft] private bool useSendMessage;

        [SerializeField] [ToggleLeft] private bool sendStateChangeMessages;
        ...
        private readonly TimedSequence<TouchPoint> touchSequence = new();
        ...
        ///     Used to keep tap's position which can't be calculated from touch points when the gesture is recognized since all
        ///     touch points are gone.
        /// </summary>
        ...
        protected virtual void Awake()
        {
            ...
            for (var i = 0; i < count; i++) AddFriendlyGesture(friendlyGestures[i]);
        ...
        protected virtual void OnDestroy()
        {
            ...
            for (var i = 0; i < count; i++) INTERNAL_RemoveFriendlyGesture(copy[i]);
    ...
    public class GestureStateChangeEventArgs : EventArgs
    {
        ...
        /// </summary>
        public Gesture.GestureState PreviousState { get; }

        /// <summary>
        ///     Current gesture state.
        /// </summary>
        public Gesture.GestureState State { get; }
    }
}