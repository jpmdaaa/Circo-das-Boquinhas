    ...
    public sealed class MetaGesture : Gesture
    {
        ...
        protected override void touchesBegan(IList<TouchPoint> touches)
        {
            ...
            if (UseSendMessage && SendMessageTarget != null)
                for (var i = 0; i < length; i++)
                    SendMessageTarget.SendMessage(TOUCH_BEGAN_MESSAGE, touches[i],
        ...
        protected override void touchesMoved(IList<TouchPoint> touches)
        {
            ...
            if (UseSendMessage && SendMessageTarget != null)
                for (var i = 0; i < length; i++)
                    SendMessageTarget.SendMessage(TOUCH_MOVED_MESSAGE, touches[i],
                        SendMessageOptions.DontRequireReceiver);
        }
        ...
        protected override void touchesEnded(IList<TouchPoint> touches)
        {
            ...
            if (UseSendMessage && SendMessageTarget != null)
                for (var i = 0; i < length; i++)
                    SendMessageTarget.SendMessage(TOUCH_ENDED_MESSAGE, touches[i],
                        SendMessageOptions.DontRequireReceiver);
        }
        ...
        protected override void touchesCancelled(IList<TouchPoint> touches)
        {
            ...
            if (UseSendMessage && SendMessageTarget != null)
                for (var i = 0; i < length; i++)
                    SendMessageTarget.SendMessage(TOUCH_CANCELLED_MESSAGE, touches[i],
                        SendMessageOptions.DontRequireReceiver);
        }
