...
namespace TouchScript.Gestures
{
    ...
    public class LongPressGesture : Gesture
    {
        ...
        [SerializeField] private float timeToPress = 1;

        [SerializeField] [NullToggle(NullFloatValue = float.PositiveInfinity)]
        ...
        protected override void touchesBegan(IList<TouchPoint> touches)
        {
            ...
            if (touchesNumState == TouchesNumState.PassedMaxThreshold ||
                ...
                setState(GestureState.Failed);
            else if (touchesNumState == TouchesNumState.PassedMinThreshold) StartCoroutine("wait");
        }
        ...
        protected override void touchesEnded(IList<TouchPoint> touches)
        {
            ...
            if (touchesNumState == TouchesNumState.PassedMinThreshold) setState(GestureState.Failed);
        }
