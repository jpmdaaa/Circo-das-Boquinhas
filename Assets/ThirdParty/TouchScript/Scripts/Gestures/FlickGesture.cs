...
{
    /// <summary>
    ///     Recognizes fast movement before releasing touches. Doesn't care how much time touch points were on surface and how
    ///     much they moved.
    /// </summary>
    ...
    public class FlickGesture : Gesture
    {
        ...
        /// <summary>
        ///     Gets or sets time interval in seconds in which touch points must move by <see cref="MinDistance" /> for gesture to
        ///     succeed.
        /// </summary>
        ...
        /// <summary>
        ///     Gets or sets minimum distance in cm to move in <see cref="FlickTime" /> before ending gesture for it to be
        ///     recognized.
        /// </summary>
        ...
        [SerializeField] private float flickTime = .1f;

        [SerializeField] private float minDistance = 1f;

        [SerializeField] private float movementThreshold = .5f;
        ...
        private readonly TimedSequence<Vector2> deltaSequence = new();
        ...
        protected override void touchesMoved(IList<TouchPoint> touches)
        {
            ...
            if (isActive || !moving)
            {
                ...
                if (movementBuffer.sqrMagnitude >= dpiMovementThreshold * dpiMovementThreshold) moving = true;
            }
        }
