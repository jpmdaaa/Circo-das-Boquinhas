...
namespace TouchScript.Gestures.UI
{
    /// <summary>
    ///     <para>
    ///         Gesture which receives touch input from TouchScript and routes it to Unity UI components on the same
    ///         GameObject.
    ///     </para>
    ...
    public class UIGesture : Gesture
    {
        ...
        /// </summary>
        protected Dictionary<int, TouchData> pointerData = new();
