...
namespace TouchScript
{
    /// <summary>
    ///     <para>
    ///         A delegate which can be set to <see cref="Gesture.Delegate" /> and control what this gesture can or can not
    ///         do.
    ///     </para>
    ///     <para>
    ///         This is a way to control very precisely how affected gestures work without inheriting from them and
