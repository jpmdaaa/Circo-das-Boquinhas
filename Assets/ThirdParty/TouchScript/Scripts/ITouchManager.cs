...
namespace TouchScript
{
    /// <summary>
    ///     <para>
    ///         Core manager of all touch input in <b>TouchScript</b>. It is responsible for assigning unique touch ids and
    ///         keeping the list of active touches. Controls touch frames and dispatches touch events.
    ///     </para>
    /// </summary>
    /// <remarks>
    ...
    ///     <list type="number">
    ///         <item>
    ///             <description>FrameStarted</description>
    ///         </item>
    ///         <item>
    ///             <description>TouchesBegan</description>
    ///         </item>
    ///         <item>
    ///             <description>TouchesMoved</description>
    ///         </item>
    ///         <item>
    ///             <description>TouchesEnded</description>
    ///         </item>
    ///         <item>
    ///             <description>TouchesCancelled</description>
    ///         </item>
    ///         <item>
    ///             <description>FrameFinished</description>
    ///         </item>
    ///     </list>
    ///     <para>
    ///         FrameStarted and FrameFinished events mark the start and the end of current touch frame and allow to
    ///         implement specific logic at these moments.
    ///     </para>
    ///     <para>
    ///         Current instance of an active object implementing <see cref="ITouchManager" /> can be obtained via
    ///         <see cref="TouchManager.Instance" />.
    ///     </para>
    /// </remarks>
    ...
    public interface ITouchManager
    {
        ...
        /// <summary>
        ///     Gets or sets a value indicating whether a <see cref="StandardInput" /> should be created in scene if no inputs
        ///     present.
        /// </summary>
        ...
        /// <param name="addIfExists">
        ///     if set to <c>true</c> move the layer to another index if it is already added; don't move
        ///     otherwise.
        /// </param>
        /// <returns>
