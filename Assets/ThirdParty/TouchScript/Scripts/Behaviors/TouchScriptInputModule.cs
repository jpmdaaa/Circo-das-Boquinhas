...
namespace TouchScript.Behaviors
{
    ...
    ///     It works without any layers or gestures but can be used with for examle a CameraLayer and BoxColliders on UI
    ///     elements to attach gestures to them.
    /// </summary>
    ...
    public class TouchScriptInputModule : BaseInputModule
    {
        ...
        ///     id to event data.
        /// </summary>
        protected Dictionary<int, PointerEventData> pointerEvents = new();
        ...
        {
            var pointerEvent = initPointerData(touch);
        ...
        {
            var pointerEvent = updatePointerData(touch);
            raycastPointer(pointerEvent);
        ...
        {
            var allow = Input.GetButtonDown(horizontalAxis);
        ...
        private bool sendMoveEventToSelectedObject()
        {
            ...
            var moveDir = axisEventData.moveDir;
