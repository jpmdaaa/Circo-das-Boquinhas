...
namespace TouchScript.Behaviors.Visualizer
{
    ...
    ///     <para>
    ///         The script should be placed on an element with RectTransform or a Canvas. A reference prefab is provided in
    ///         TouchScript package.
    ///     </para>
    /// </summary>
    ...
    public class TouchVisualizer : MonoBehaviour
    {
        ...
        /// <summary>
        ///     Gets or sets the size of touch cursors in cm. This value is only used when <see cref="UseDPI" /> is set to
        ///     <c>true</c>.
        /// </summary>
        ...
        [SerializeField] private TouchProxyBase touchProxy;

        [SerializeField] private bool showTouchId = true;

        [SerializeField] private bool showTags;

        [SerializeField] private bool useDPI = true;
        ...
        private readonly Dictionary<int, TouchProxyBase> proxies = new(10);
