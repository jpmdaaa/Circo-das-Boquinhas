...
namespace TouchScript.Devices.Display
{
    ...
    /// <remarks>
    ///     <para>
    ///         TouchScript uses display device to calculate gesture properties based on device's DPI. This makes it possible
    ///         to have the same experience on mobile devices with high DPI and large touch surfaces which have low DPI.
    ///     </para>
    ///     <para>
    ///         Current instance of <see cref="IDisplayDevice" /> can be accessed via
    ///         <see cref="ITouchManager.DisplayDevice" />.
    ///     </para>
    /// </remarks>
