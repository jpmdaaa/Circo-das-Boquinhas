...
namespace TouchScript.Hit
{
    ...
    public class Untouchable : HitTest
    {
        ...
        /// <summary>
        ///     Indicates if instead of not reacting to touches the object should completely discard them making it impossible for
        ///     other gestures to receive them.
        /// </summary>
        /// <value>
        ///     If <c>true</c> touch points are not only prevented but discarded making it impossible for other gestures to
        ///     receive them.
        /// </value>
