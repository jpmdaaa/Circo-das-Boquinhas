...
namespace TouchScript.Hit
{
    ...
    public abstract class HitTest : MonoBehaviour
    {
        ...
        /// <returns>
        ///     <see cref="ObjectHitResult.Hit" /> if touch point hits the object, <see cref="ObjectHitResult.Miss" /> if it
        ///     doesn't, <see cref="ObjectHitResult.Discard" /> if it doesn't and this touch must be ignored, Error otherwise.
        /// </returns>
