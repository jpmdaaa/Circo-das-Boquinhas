...
namespace TouchScript.Clusters
{
    ...
    public sealed class Clusters
    {
        ...
        /// <remarks>
        ///     This value is used to set the limit of how close cluster can be. Sometimes very close points shouldn't be
        ///     treated as being in separate clusters.
        /// </remarks>
        ...
        private readonly List<TouchPoint> points = new();
        private bool dirty;
        private readonly List<TouchPoint> cluster1 = new();
        private readonly List<TouchPoint> cluster2 = new();
        ...
        /// <param name="id"> Cluster id. Either <see cref="CLUSTER1" /> or <see cref="CLUSTER2" />. </param>
        /// <returns>
        ///     Cluster's centroid previous position or <see cref="TouchManager.INVALID_POSITION" /> if cluster contains no
        ///     points.
        /// </returns>
