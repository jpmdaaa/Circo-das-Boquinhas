...
namespace TouchScript.Layers
{
    ...
    public class UILayer : TouchLayer
    {
        ...
        [NonSerialized] private readonly List<RaycastResult> raycastResultCache = new(20);

        private readonly List<HitTest> tmpHitTestList = new(10);

        private PointerEventData pointerDataCache;
        private EventSystem eventSystem;
        private readonly Dictionary<Canvas, ProjectionParams> projectionParamsCache = new();
