...
{
    /// <summary>
    ///     Touch layer which represents a 3d camera looking into the world. Determines which objects may be hit in the view of
    ///     a camera attached to parent GameObject.
    /// </summary>
    ...
    public class CameraLayer : CameraLayerBase
    {
        ...
        private readonly List<RaycastHit> sortedHits = new(20);
        private Transform cachedTransform;
        private readonly List<HitTest> tmpHitTestList = new(10);
