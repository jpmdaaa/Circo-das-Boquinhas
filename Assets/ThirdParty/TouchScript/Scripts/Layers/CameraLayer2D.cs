...
namespace TouchScript.Layers
{
    ...
    public class CameraLayer2D : CameraLayerBase
    {
        ...
        [SerializeField] [HideInInspector] private int[] layerIds = new int[0];

        private readonly Dictionary<int, int> layerById = new();
        private readonly List<RaycastHit2D> sortedHits = new(20);
