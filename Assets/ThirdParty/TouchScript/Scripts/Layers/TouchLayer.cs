...
namespace TouchScript.Layers
{
    ...
    /// <remarks>
    ///     <para>
    ///         In <b>TouchScript</b> it's a layer's job to determine if a touch on the screen hits anything in Unity's 3d/2d
    ///         world.
    ///     </para>
    ///     <para>
    ///         <see cref="ITouchManager" /> keeps a sorted list of all layers in <see cref="ITouchManager.Layers" /> which
    ///         it queries when a new touch appears. It's a layer's job to return <see cref="LayerHitResult.Hit" /> if this
    ///         touch hits an object. Layers can even be used to "hit" objects outside of Unity's 3d world, for example
    ///         <b>Scaleform</b> integration is implemented this way.
    ///     </para>
    ///     <para>
    ///         Layers can be configured in a scene using <see cref="TouchManager" /> or from code using
    ///         <see cref="ITouchManager" /> API.
    ///     </para>
    ///     <para>
    ///         If you want to route touches and manually control which objects they should "touch" it's better to create a
    ///         new layer extending <see cref="TouchLayer" />.
    ///     </para>
    /// </remarks>
    [ExecuteInEditMode]
    public abstract class TouchLayer : MonoBehaviour
    {
        ...
        /// <returns>
        ///     <see cref="LayerHitResult.Hit" />, if an object is hit, <see cref="LayerHitResult.Miss" /> or
        ///     <see cref="LayerHitResult.Error" /> otherwise.
        /// </returns>
