...
{
    /// <summary>
    ///     A façade object to configure and hold parameters for an instance of <see cref="ITouchManager" />. Contains
    ///     constants used throughout the library.
    ///     <seealso cref="ITouchManager" />
    /// </summary>
    /// <remarks>
    ///     <para>
    ///         An instance of <see cref="TouchManager" /> may be added to a Unity scene to hold (i.e. serialize them to the
    ///         scene) parameters needed to configure an instance of <see cref="ITouchManager" /> used in application. Which
    ///         can be accessed via <see cref="TouchManager.Instance" /> static property.
    ///     </para>
    ///     <para>
    ///         Though it's not required it is a convenient way to configure <b>TouchScript</b> for your scene. You can use
    ///         different configuration options for different scenes.
    ///     </para>
    /// </remarks>
    /// <example>
    ...
    public sealed class TouchManager : MonoBehaviour
    {
        ...
        /// <summary>
        ///     The value used to represent an unknown state of a screen position. Use
        ///     <see cref="TouchManager.IsInvalidPosition" /> to check if a point has unknown value.
        /// </summary>
        ...
        ///     TouchScript version.
        /// </summary>
        public static readonly Version VERSION = new(8, 3);
        ...
        public static ITouchManager Instance => TouchManagerInstance.Instance;
        ...
        /// <remarks>
        ///     This is usually a desired behavior but sometimes you would want to turn this off if you are using TouchScript
        ///     only to get touch input from some device.
        /// </remarks>
        public bool ShouldCreateCameraLayer
        {
            get => shouldCreateCameraLayer;
            set => shouldCreateCameraLayer = value;
        }

        /// <summary>
        ///     Gets or sets a value indicating whether a <see cref="TouchScript.InputSources.StandardInput" /> should be created
        ///     in scene if no inputs present.
        /// </summary>
        ...
        {
            get => shouldCreateStandardInput;
            set => shouldCreateStandardInput = value;
        }

        /// <summary>
        ///     Gets or sets a value indicating whether Unity messages are sent when <see cref="ITouchManager" /> dispatches
        ///     events.
        /// </summary>
        /// <value><c>true</c> if Unity messages are used; otherwise, <c>false</c>.</value>
        /// <remarks>
        ///     If Unity messages are used they are sent to an object set as a value of <see cref="SendMessageTarget" />
        ///     property or to TouchManager's GameObject if it's <c>null</c>.
        /// </remarks>
        ...
        /// <summary>
        ///     Gets or sets the bit-mask which indicates which events from an instance of <see cref="ITouchManager" /> are sent as
        ///     Unity messages.
        /// </summary>
        /// <value>Bit-mask with corresponding bits for used events.</value>
        public MessageType SendMessageEvents
        {
            get => sendMessageEvents;
            set
            {
        ...
        [SerializeField] [ToggleLeft] private bool useSendMessage;

        [SerializeField] private MessageType sendMessageEvents =
            MessageType.TouchesBegan | MessageType.TouchesCancelled |
            MessageType.TouchesEnded | MessageType.TouchesMoved;

        [SerializeField] private GameObject sendMessageTarget;

        [SerializeField] private List<TouchLayer> layers = new();
        ...
        private void Awake()
        {
            ...
            for (var i = 0; i < layers.Count; i++) Instance.AddLayer(layers[i], i);
        }
