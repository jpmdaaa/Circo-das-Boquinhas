...
namespace TouchScript
{
    ...
    ///     <para>
    ///         An object implementing this interface is created when user touches the screen. A unique id is assigned to it
    ///         which doesn't change throughout its life.
    ///     </para>
    ///     <para>
    ///         <b>Attention!</b> Do not store references to these objects beyond touch's lifetime (i.e. when target finger
    ///         is lifted off). These objects may be reused internally. Store unique ids instead.
    ///     </para>
    /// </summary>
    public class TouchPoint
    {
        ...
        /// </summary>
        public ProjectionParams ProjectionParams => Layer.GetProjectionParams(this);
        ...
        internal void INTERNAL_Init(int id, Vector2 position, IInputSource input, Tags tags)
        {
            Id = id;
            InputSource = input;
            Position = PreviousPosition = newPosition = position;
